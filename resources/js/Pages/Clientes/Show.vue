    ...
    <AuthenticatedLayout>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="">
                ...
                <a v-if="mostrarboton == 1" :href="rutaPDF" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm me-2"><i class="fa-brands fa-searchengin"></i> Ver Consent Form</a>
        ...
        <div class="row">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="datos-personales-tab" data-bs-toggle="tab" data-bs-target="#datos-personales" type="button" role="tab" aria-controls="datos-personales" aria-selected="true">
                        <span><i class="fa-solid fa-address-card me-2"></i>Personal</span>
                    </button>
                    <button class="nav-link" id="datos-financieros-tab" data-bs-toggle="tab" data-bs-target="#datos-financieros" type="button" role="tab" aria-controls="datos-financieros" aria-selected="false">
                        <span><i class="fa-solid fa-money-check-dollar me-2"></i>Financiera</span>
                    </button>
                    <button class="nav-link" id="datos-conyugue-tab" data-bs-toggle="tab" data-bs-target="#datos-conyugue" type="button" role="tab" aria-controls="datos-conyugue" aria-selected="false">
                        <span><i class="fa-solid fa-restroom me-2"></i>Conyugue</span>
                    </button>
                    <button class="nav-link" id="datos-dependientes-tab" data-bs-toggle="tab" data-bs-target="#datos-dependientes" type="button" role="tab" aria-controls="datos-dependientes" aria-selected="false">
                        <span><i class="fa-solid fa-children me-2"></i>Dependientes</span>
                    </button>
            ...
            <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="container">
                            <div class="border px-4">
                                <div class="d-flex justify-content-end">
                                    ...
                                    <Link class="btn btn-sm btn-primary me-2 mt-2" :href="route('editdatos.edit', cliente.id)">
                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p class="text-dark"><strong>Agente que lo atendio: </strong> <span class="text-primary fw-bold"> {{ cliente.user.name }} {{ cliente.user.lastname }} </span></p>
                                        </div>
                                    </div>
                                    <div class="row d-flex justify-content-center mt-3">
                                        <div class="col-md-4 text-center">
                                            <div v-if="cliente.activo == 0" class="alert alert-primary" role="alert">
                                                Condición del Cliente: <span class="text-primary-emphasis fw-bold">Cliente Activo</span>
                                            </div>
                                            <div v-if="cliente.activo == 1" class="alert alert-danger" role="alert">
                                                Condición del Cliente: <span class="text-primary-emphasis fw-bold">Cliente Inactivo</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="datos-financieros" role="tabpanel" aria-labelledby="datos-financieros-tab" tabindex="0">
                    <div class="row">
                        <div class="container">
                            <div class="border px-4">
                                <div class="d-flex justify-content-end">
                                    <!-- <span><i class="fa-solid fa-money-check-dollar"></i> Información financiera</span> -->
                                    <Link class="btn btn-sm btn-primary me-2 mt-2" :href="route('editfinanzas.edit', cliente.id)">
                                        <i class="fas fa-edit"></i> Editar
                                    </Link>
                                </div>
                                <div class="card-body">
                ...
                <div class="tab-pane fade" id="datos-conyugue" role="tabpanel" aria-labelledby="datos-conyugue-tab" tabindex="0">
                    <div class="row">
                        <div class="container">
                            <div class="border px-4">
                                <div class="d-flex justify-content-end">
                                    ...
                                    <template v-if="cliente.estadocivil === 'soltero'">
                                        <div class="row">
                                            ...
                                            <Link class="btn btn-sm btn-primary me-2 mt-2" :href="route('nuevocliente.createconyugue2', cliente.id)">
                ...
                <div class="tab-pane fade" id="datos-dependientes" role="tabpanel" aria-labelledby="datos-dependientes-tab" tabindex="0">
                    <div class="row">
                        <div class="container">
                            <div class="border px-4">
                                <div class="d-flex justify-content-end">
                                    <!-- <span><i class="fa-solid fa-children me-3"></i>Información de los Dependientes</span> -->
                                    <Link class="btn btn-sm btn-primary  mt-2" :href="route('nuevocliente.createdependiente2', cliente.id)">
