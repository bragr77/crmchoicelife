                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-12 col-xl-4 mb-xl-0 mb-2">
                                                <Link class="btn btn-primary" :href="route('nuevocliente.createdependiente', cliente.id)">
                                            ...
                                            <div class="col-12 col-xl-4 mb-xl-0 mb-2" v-show="cliente.estadocivil === 'soltero'">
                                                <Link class="btn btn-info" :href="route('nuevocliente.createconyugue', cliente.id)">
                                                    <i class="fa-solid fa-plus me-2"></i>Agregar Conyugue
                                                </Link>
                                            </div>
                                            <div class="col-12 col-xl-4">
                                                <Link class="btn btn-secondary" @click="mostrarloading=true" :href="route('finalizar', cliente.id)">
