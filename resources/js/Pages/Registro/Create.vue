        ...
        <div class="container mt-2">
            <div class="card">
                <div class="card-header text-center">
                    ...
                    <span class="fw-bold">FORMULARIO DE REGISTRO</span>
                </div>
                <div class="card-body">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 col-md-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example" id="cl_estatus" v-model="form.cl_estatus">
                                        <option :value="null">Selecciona....</option>
                                        <option valued="Ciudadano">Ciudadano</option>
                                        <option valued="Residente">Residente</option>
                                        <option valued="Permiso de Trabajo">Permiso de Trabajo</option>
                                        <option valued="Solicitud de Asilo">Solicitud de Asilo</option>
                                        <option valued="Petición">Petición</option>
                                    </select>
...
<script>
    ...
    setup(){
        ...
        function submit(){
            router.post(route('registro.store'), form);
        }
