        ...
        <div class="w-full">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mt-4">
              ...
              <TextInput id="lastname" type="text" class="block w-full mt-1" v-model="form.lastname" required />
              <InputError class="mt-2" :message="form.errors.lastname" />
            </div>

            <div class="mt-4">
              <InputLabel for="role" value="Role" />
              <TextInput id="role" type="number" class="block w-full mt-1" v-model="form.role_id" required />
