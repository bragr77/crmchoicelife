<template>
  <aside class="z-20 hidden w-64 overflow-y-auto bg-white lg:block flex-shrink-0">
    <div class="py-4 text-gray-500">
      <Link class="row subrayado ml-6 text-lg font-bold text-gray-800 order-border-dark" :href="route('dashboard.index')">
          <div class="row">
      ...
      <ul class="mt-6">
        ...
        <li v-if="$page.props.auth.user.role_id != 3" class="relative px-6 py-3">
          <NavLink :href="route('clientinactivo.index')" :active="route().current('clientinactivo.index')">
            <template #icon>
        ...
        <li v-if="$page.props.auth.user.role_id != 3" class="relative px-6 py-3">
          <NavLink :href="route('conyugues.index')" :active="route().current('conyugues.index')">
            <template #icon>
        ...
        <li v-if="$page.props.auth.user.role_id != 3" class="relative px-6 py-3">
          <NavLink :href="route('dependientes.index')" :active="route().current('dependientes.index')">
            <template #icon>
